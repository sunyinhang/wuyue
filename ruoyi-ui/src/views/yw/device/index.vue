<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="年限" prop="timeLimit">
        <el-input
      ...
      <el-form-item label="负责人id" prop="supervisor">
        <el-input
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="负责人id" align="center" prop="id" />
      ...
      <el-table-column label="年限" align="center" prop="timeLimit" />
      <el-table-column label="状态" align="center" prop="status" />
      <el-table-column label="负责人id" align="center" prop="supervisor" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="年限" prop="timeLimit">
          <el-input v-model="form.timeLimit" placeholder="请输入年限" />
        </el-form-item>
        ...
        <el-form-item label="负责人id" prop="supervisor">
          <el-input v-model="form.supervisor" placeholder="请输入负责人id" />
        </el-form-item>
      </el-form>
...
<script>
import { listDevice, getDevice, delDevice, addDevice, updateDevice, exportDevice } from "@/api/yw/device";
